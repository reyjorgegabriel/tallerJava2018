 ...
 * 
 */
@WebServiceClient(name = "WebServiceServletService", targetNamespace = "http://antel.com.uy/", wsdlLocation = "file:/D:/a%20imp,%20temp,%20etc/echo.xml")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/D:/a%20imp,%20temp,%20etc/echo.xml");
