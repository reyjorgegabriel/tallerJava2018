...
/**
 * <p>Clase Java para anularTicketResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="anularTicketResponse">
 *   &lt;complexContent>
...
@XmlType(name = "anularTicketResponse", propOrder = {
    "_return"
})
public class AnularTicketResponse {
